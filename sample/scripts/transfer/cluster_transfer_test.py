...
def main(TH: int):
    ...
    for raw_csv in raw_csvs:
        ...
        # get cluster map
        #对于每个raw KPI，他的每一天属于哪个cluster，cluster_map{'0':'cluster-0'}
        ...
        #对于raw_kpi训练，找到训练集合的每一天属于哪一类，然后load那一类的base model训练
        for weekday, kpi_seq in train_week_day_map.items():
            ...
            #${COMMON:project_path}/out/transfer_learning/models/18-20/cluster-0
